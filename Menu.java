    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pkt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent inte = new Intent(com.example.chotabim.Menu.this, Paket.class);
                startActivity(inte);
        ...
        prfl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent inte = new Intent(com.example.chotabim.Menu.this, Profile.class);
                startActivity(inte);
        ...
        out.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent inte = new Intent(com.example.chotabim.Menu.this, Login.class);
                startActivity(inte);
